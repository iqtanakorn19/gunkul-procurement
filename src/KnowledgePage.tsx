...
const DOCS: Doc[] = [
  { id: "wi001", title: "WI-001 — Add Vendor", description: "ขั้นตอนการเพิ่ม Vendor ใหม่เข้าระบบ D365 พร้อมเอกสารที่ต้องเตรียม", type: "wi", pages: "19 หน้า", url: "/documents/draft%20WI_Add_Vendor_01.pdf", icon: "👤" },
  { id: "wi002", title: "WI-002 — Purchase Order", description: "ขั้นตอนการสร้าง PO ในระบบ D365 ตั้งแต่รับ PR จนถึงส่งให้ Supplier", type: "wi", pages: "33 หน้า", url: "/documents/draft%20WI_Purchase_Order_01.pdf", icon: "🛒" },
  { id: "wi003", title: "WI-003 — Price Approval", description: "กระบวนการขออนุมัติราคา PA ตามระดับวงเงิน Manager / VP / CEO", type: "wi", pages: "30 หน้า", url: "/documents/draft%20WI_Price_Approval_01.pdf", icon: "✅" },
  { id: "wi004", title: "WI-004 — Good Receipt", description: "ขั้นตอนการทำ Good Receive หลัง Supplier ส่งของ เพื่อให้บัญชีจ่ายเงินได้", type: "wi", pages: "16 หน้า", url: "/documents/draft%20WI_Good_Receipt_01.pdf", icon: "📦" },
